...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
        ...
        KC_LSFT,          RGB_NITE,_______, _______, _______, QK_BOOT, KC_NUM,  _______, _______, DOTCOM,  KC_CAD,           _______, RGB_MOD,  _______,
    ...
    [_FN1] = LAYOUT(
        ...
        KC_CAPS, RGB_HUD, RGB_VAD, RGB_HUI, _______, GMAIL,   HOTMAIL, _______, _______, LOCKPC,  _______, _______,          _______,           KC_END,
        KC_LSFT,          RGB_NITE,_______, _______, _______, QK_BOOT, KC_NUM,  _______, _______, DOTCOM,  KC_CAD,           _______, RGB_MOD,  _______,
        KC_LCTL, WINLOCK, KC_LALT,                            _______,                            KC_RALT, _______, KC_RCTL, RGB_SPD, RGB_RMOD, RGB_SPI
    ),
    #endif  //GAME_ENABLE
